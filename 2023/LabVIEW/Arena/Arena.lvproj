...
<Project Type="Project" LVVersion="21008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Accessories" Type="Folder">
			<Item Name="Accessory" Type="Folder">
				<Item Name="Accessory.lvclass" Type="LVClass" URL="../Accessory/Accessory.lvclass"/>
			</Item>
			<Item Name="Armor" Type="Folder">
				<Item Name="Armor.lvclass" Type="LVClass" URL="../Armor/Armor.lvclass"/>
			</Item>
			<Item Name="Magic" Type="Folder">
				<Item Name="Magic.lvclass" Type="LVClass" URL="../Magic/Magic.lvclass"/>
			</Item>
			<Item Name="Weapon" Type="Folder">
				<Item Name="Weapon.lvclass" Type="LVClass" URL="../Weapon/Weapon.lvclass"/>
			</Item>
		</Item>
		<Item Name="Cube.vi" Type="VI" URL="../Cube.vi"/>
		<Item Name="Knight.lvclass" Type="LVClass" URL="../Knight/Knight.lvclass"/>
		<Item Name="main.vi" Type="VI" URL="../main.vi"/>
		<Item Name="Peasant.lvclass" Type="LVClass" URL="../Peasant/Peasant.lvclass"/>
